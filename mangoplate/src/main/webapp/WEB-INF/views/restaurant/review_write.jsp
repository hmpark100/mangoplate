		...
		<article class="first">
			<form name="#" action="#" method="#">
				<div>
					<ul>
						<li>
							<input type="radio" name="rating" class="super-happy" id="super-happy" value="super-happy" /><img src="http://localhost:9000/mangoplate/resources/images/delicious_checked.png">
							<span>맛있다</span>
							<input type="radio" name="rating" class="happy" id="happy" value="happy" checked /><img src="http://localhost:9000/mangoplate/resources/images/NotBad_unchecked.png">
							<span>괜찮다</span>
