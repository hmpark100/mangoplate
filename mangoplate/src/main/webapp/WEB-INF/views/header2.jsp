...
<header class="Header Header--Transparent" data-page="home">
		...
		<ul class="Header__MenuList">
			...
			<li class="Header__MenuItem"><a href="boardstory_list.do"
		...
		<ul class="Header__IconButtonList">
			<li
				class="Header__IconButtonItem only-mobile Header__IconButtonItem--MenuButton">
			...
			<li
				...
				<button class="UserProfileButton"
					...
					<i class="UserProfileButton__Picture"></i> <i
						class="UserProfileButton__PersonIcon"></i> <span
