		...
		<div class="inner">
			<div class="mp_logo">
				<a href="/" class="btn-mp"> <img class="mp_logo_img"
					src="https://mp-seoul-image-production-s3.mangoplate.com/web/resources/mycgv-gray-logo.svg"
					alt="mangoplate logo">
				</a>
			...
			<p class="sns-shortcut">
				<a class="btn facebook" href="https://www.facebook.com/mycgv"
					target="_blank" onclick="trackEvent('CLICK_SHARE_FACEBOOK');">
					망고플레이트 페이스북 계정으로 바로가기 </a> <a class="btn instagram"
					href="https://instagram.com/mycgv/" target="_blank"
